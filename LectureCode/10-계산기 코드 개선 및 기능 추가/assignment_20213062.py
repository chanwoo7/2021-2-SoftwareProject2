...
class Calculator(QWidget):
    ...
    def buttonClicked(self):
        ...
        if key == '=':
            ...
            for constantLabel in constantDic.keys():
                if key == constantLabel:
                    self.display.setText(self.display.text() + constantDic[constantLabel])
        elif key in functionDic.keys():
            for functionLabel in functionDic.keys():
                if key == functionLabel:
                    n = self.display.text()
                    value = functionDic[functionLabel](n)
